...
public class SetWin1Command implements SubCommand {

    private final TGSquidGame plugin;

    public SetWin1Command(TGSquidGame plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length < 1) {
            player.sendMessage(ChatColor.RED + "Usage: /tgsg <arenaName> setwin1");
            return true;
        }
