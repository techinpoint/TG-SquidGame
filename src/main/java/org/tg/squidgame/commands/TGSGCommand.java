...
public class TGSGCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length >= 2 && !subCommands.containsKey(subCommandName)) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 2) {
            if (plugin.getArenaManager().arenaExists(args[0])) {
                completions.addAll(Arrays.asList("edit", "save", "cancel", "setpos1", "setpos2",
                    "setstart1", "setstart2", "setwin1", "setwin2", "setlobby", "setspec",
                    "enablebarrier", "disablebarrier", "start", "stop"));
            ...
            if ("delete".equals(args[0]) || "join".equals(args[0])) {
                completions.addAll(plugin.getArenaManager().getArenaNames());
                return filterCompletions(completions, args[1]);
            }
        }
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "/tgsg <arena> edit" + ChatColor.GRAY + " - Open settings GUI");
