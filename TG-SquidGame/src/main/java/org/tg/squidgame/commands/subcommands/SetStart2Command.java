...
public class SetStart2Command implements SubCommand {

    private final TGSquidGame plugin;

    public SetStart2Command(TGSquidGame plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length < 1) {
            player.sendMessage(ChatColor.RED + "Usage: /tgsg <arenaName> setstart2");
            return true;
        }
